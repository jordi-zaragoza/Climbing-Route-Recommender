...
# ---------------- Similar strings ------------------------
    ...
    def replace_frequent_uniq(a,b,uniq_ls,orig_ls):
        '''
        Compare the ocurrences of each string of a unique list and 
    ...
    def replace_frequent_with_table(self, orig_ls, similarity = 0.85, similarity_ask = 1, show = False):
        ...
        -- This method improves the one above for large repetitive lists, check GUIDE.text_processor_class for more details --
