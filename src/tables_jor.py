...
def clean_ascent(df):
    ...
    ascent_df2 = ascent_df2.drop(columns = ['raw_notes','exclude_from_ranking','climb_type','total_score','date','year','rec_date','project_ascent_date','yellow_id','climb_try','description','method_id','last_year'])
